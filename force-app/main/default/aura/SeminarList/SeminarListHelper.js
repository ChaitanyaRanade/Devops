({
	...
	searchSeminarsHelper : function(semComp,semEvent) {
        console.log("---Event----"+semEvent);
        var carryCatEvt = semEvent.getParam("selCategory");
        console.log("---selected category----"+carryCatEvt);
        ...
        }else
        {
            ...
            semAction.setParam("Category", carryCatEvt);
            semAction.setCallback(this,
                                 function(semResp)
                                  {
                                      semComp.set("v.seminars", semResp.getReturnValue());
